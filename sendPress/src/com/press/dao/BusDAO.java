...
public class BusDAO extends HibernateDaoSupport {
	...
	public Bus findById(java.lang.Integer id) {
		...
		try {
			Bus instance = (Bus) getHibernateTemplate().get("com.press.pojo.Bus", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByProperty(String propertyName, Object value) {
		log.debug("finding Bus instance with property: " + propertyName + ", value: " + value);
		try {
			String queryString = "from Bus as model where model." + propertyName + "= ?";
	...
	public List findByBusName(Object busName) {
		return findByProperty(BUS_NAME, busName);
	}
